...
export default function tafqit(NumIn = 0, { Feminine, Comma, SplitHund, Miah, Billions, TextToFollow, AG, Subject, Legal } = {}) {
  ...
  function oneTripletToWords() {
    ...
    if (Feminine === ON && IsLastEffTriplet) { // If Feminine, use the Feminine table if Last Effective Triplet
      ...
      Table11_19[2] = Ethnata;                   // Feminine starting words for [I12
